...
class AccountCreatedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject('Selamat, ' . $this->user->full_name . '! Akun Anda Berhasil Dibuat')
            ->greeting('Halo, ' . $this->user->full_name . ' 🎉')
            ->line('Akun Anda di **Kasir Digital** telah berhasil dibuat. Namun, saat ini akun Anda masih menunggu persetujuan dari admin untuk dapat mengakses aplikasi kasir.')
            ->line('Kami akan menginformasikan kepada Anda setelah akun Anda disetujui.')
            ->salutation('Salam hangat, **Tim Kasir Digital**');
    }

...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white shadow-lg rounded-lg p-8 max-w-md text-center">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mt-4">Account Denied</h1>
        <p class="text-gray-600 mt-2">Your account request has been denied. Please contact support for further
            assistance.</p>

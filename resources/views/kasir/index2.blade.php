...
<body class="flex h-screen overflow-hidden bg-gray-100">
    <!-- Sidebar Kiri -->
    <aside class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-white duration-300 ease-linear shadow-md lg:static lg:translate-x-0">
                ...
                <div class="flex items-center gap-3 2xsm:gap-7">
                    <ul class="flex items-center gap-2 2xsm:gap-4">
                        ...
                        <li class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
                            <button
                                class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-0 bg-red-100 hover:text-red-800 " id="cart-button">
                                {{-- <svg width="18"
                                ...
                                <svg width="18" class="fill-current duration-300 ease-in-out text-red-400"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M0 24C0 10.7 10.7 0 24 0L69.5 0c22 0 41.5 12.8 50.6 32l411 0c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3l-288.5 0 5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5L488 336c13.3 0 24 10.7 24 24s-10.7 24-24 24l-288.3 0c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5L24 48C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96z"/></svg>
                            </button>
                        </li>
                        <!-- Chat Notification Area -->
                    </ul>
    ...
    <aside id="cart-aside" class="absolute right-0 top-0 h-screen w-72 bg-white shadow-lg mt-20 transform translate-x-full transition-transform duration-300">
        <div class="p-4 flex justify-between items-center bg-gray-200">
            <h2 class="text-lg font-semibold">Keranjang</h2>
            <button id="close-cart" class="text-red-500">✖</button>
        </div>
        <div class="p-4">
            <p>Isi keranjang belanja Anda.</p>
        </div>
    </aside>

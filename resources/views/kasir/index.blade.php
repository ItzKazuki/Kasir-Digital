...
<body class="flex h-screen overflow-hidden bg-gray-100">
            ...
            <nav class="mt-5 px-4 py-4 lg:mt-3 lg:px-6">
                <div>
                    ...
                    <ul class="mb-6 flex flex-col gap-1.5">
                        <li>
                            <a class="group relative flex items-center gap-2.5 bg-red-100  rounded-sm px-4 py-2 font-medium text-red-600 duration-300 ease-in-out hover:bg-red-200"
                                href="#">
                                <svg class="fill-current text-red-600" width="18" height="18" viewBox="0 0 18 18"
                        ...
                        <li>
                            <a class="group relative flex items-center gap-2.5  rounded-sm px-4 py-2 font-medium duration-300 ease-in-out hover:bg-red-200"
                                href="#">
            ...
            <div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
                ...
                <div class="flex items-center gap-3 2xsm:gap-7">
                    ...
                    <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                        ...
                        <!-- Dropdown Start -->
                        <div x-show="dropdownOpen"
                            class="absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-red-100 bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                            <ul class="flex flex-col gap-5 border-b border-red-100 px-6 py-7.5 dark:border-strokedark">
                                <li>
                                    <a href="profile.html"
    ...
    <aside
        class="absolute right-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-white duration-300 ease-linear shadow-md lg:static lg:translate-x-0">
        <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
            <nav class="mt-5 px-4 py-4 lg:mt-3 lg:px-6">
                <div>
                    <h3 class="mb-4 ml-4 text-xl font-bold text-bodydark2">Keranjang</h3>
                    <ul class="mb-6 flex flex-col gap-1.5">
                        <li>

    ...
    <div class="flex flex-col gap-10">
        ...
        <div
            ...
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('dashboard.discounts.create') }}" class="flex font-bold justify-center rounded bg-red-600 px-6 py-2 text-white hover:bg-red-700">
                    Tambah Produk
                </a>
            </div>
            ...
            <div class="flex flex-col">
                ...
                @foreach ($discounts as $discount)
                    <div class="grid grid-cols-3 border-b border-gray-300 dark:border-gray-300dark sm:grid-cols-7">
                        ...
                        <div class="flex items-center justify-center p-2 xl:p-5">
                            <p class="font-medium {{ $discount->status == 'active' ? 'text-green-600' : 'text-red-600' }}">{{ $discount->type == 'fixed' ? 'Rp. ' . number_format($discount->value, 2, ',', '.') : $discount->value . '%' }}</p>
                        </div>

                    ...
                    <div class="p-7">
                        <form action="{{ route('dashboard.users.update', $user->id) }}" method="POST">
                            ...
                            <div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                                <div class="w-full sm:w-1/2">
                                    ...
                                    <input
                                        ...
                                        type="text" name="full_name" id="full_name" value="{{ $user->full_name }}" placeholder="John Doe" />
                                    @error('full_name')
                            ...
                            <div class="mb-5.5">
                                ...
                                <input
                                    class="w-full rounded border border-gray-300 bg-gray-200 py-3 px-4.5 font-medium text-black focus:border-red-600 focus-visible:outline-none"
                                    type="email" name="email" id="email" value="{{ $user->email }}" placeholder="someone@domain.com" />
                                @error('email')
                                    <div class="mt-1 text-red-600">
                                        <p class="text-xs">{{ $message }}</p>
                                    </div>
                            ...
                            <div class="mb-5.5">
                                ...
                                <input
                                    class="w-full rounded border border-gray-300 bg-gray-200 px-4.5 py-3 font-medium text-black focus:border-red-600 focus-visible:outline-none"
                                    type="text" name="username" id="username" value="{{ $user->username }}" placeholder="yourname" />
                                @error('username')
                                    <div class="mt-1 text-red-600">
                                        <p class="text-xs">{{ $message }}</p>
                                    </div>

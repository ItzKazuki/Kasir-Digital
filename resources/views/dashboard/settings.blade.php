                            ...
                            <div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                                <div class="w-full sm:w-1/2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input
                                            ...
                                            type="text" name="full_name" id="full_name" placeholder="Devid Jhon"
                                ...
                                <div class="w-full sm:w-1/2">
                                    ...
                                    <input
                                        ...
                                        type="tel" name="phone_number" id="full_name" placeholder="+990 3343 7865"
                                        value="{{ $user->no_telp }}" />
                                </div>
                            </div>
                        ...
                        <form action="{{ route('dashboard.settings.update-profile') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 flex items-center gap-3">
                                <div class="h-14 w-14 rounded-full">
                                    <img class="rounded-full aspect-square object-cover" src="{{ Storage::url('static/images/profiles/' . $user->profile_img) ?? Avatar::create($user->full_name)->toBase64() }}"
                                        alt="User" />
                                </div>
                                <div>
